...
<table>
			...
			<tr>
				<td>Project :</td>
				<td><form:select path="project" items="${projectMap}"/>  
                  </td>             
			</tr>
			<tr>
				<td>User :</td>
				...
				<a href="javascript:location.href='task-load.htm?user='+document.getElementById('user').value+'&project='+document.getElementById('project').value" onclick="return parameter();">Add New Task</a>
				</td>
